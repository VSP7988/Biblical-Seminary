    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@maranatha.edu</span>
              </li>
              <li className="flex items-center space-x-3">
                <MapPin className="h-5 w-5 text-primary" />
                <span className="text-gray-400">123 Seminary Drive, City, State 12345</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex justify-between items-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Maranatha Biblical Seminary. All rights reserved.</p>
